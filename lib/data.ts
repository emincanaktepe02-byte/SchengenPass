...
export const COUNTRIES: Country[] = [
  ...
  // ── BLS International ─────────────────────────────────────
  {
    ...
    popularCity: "Madrid",
    destinationCode: "MAD",
    centers: ["İstanbul (İzmir başvurularını da alır)", "Ankara"],
    centerOperator: "BLS International",
    centerUrl: "https://blsiber.com/tr/",
    visible: false,
    tips: [
      "BLS International, İspanya vize başvurularını Türkiye'de yönetmektedir. İstanbul merkezi İzmir bölgesindeki başvuru sahiplerini de kabul etmektedir.",
